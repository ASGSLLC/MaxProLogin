...
namespace maxprofitness.shared
{
    ...
    public Dictionary<string, string> BLEStandardUUIDs = new Dictionary<string, string>();
        ...
        {
            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// message " + message);
            ...
            if (message != null)
            {
                ...
                //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// parts.length " + parts.Length);
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceInitializedString // ");

                    if (InitializedAction != null)
                    {
                        InitializedAction();

                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// calling InitializedAction // ");
                    }
                }
                else if (message.Length >= deviceLog.Length && message.Substring(0, deviceLog.Length) == deviceLog)
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceLog // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDeInitializedString // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceErrorString // ");
                    ...
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage calling ErrorAction// error " + error);
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceServiceAdded // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceStartedAdvertising // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceStoppedAdvertising // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDiscoveredPeripheral // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDiscoveredBeacon // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceRetrievedConnectedPeripheral // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// devicePeripheralReceivedWriteData // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceConnectedPeripheral // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDisconnectedPeripheral // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDiscoveredService // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDiscoveredCharacteristic // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDidWriteCharacteristic // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDidUpdateNotificationStateForCharacteristic // ");

                    if (parts.Length >= 3)
                    {
                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDidUpdateNotificationStateForCharacteristic // parts.Length >= 3");

                        if (DidUpdateNotificationStateForCharacteristicAction != null)
                        {
                            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // have DidUpdateNotificationStateForCharacteristicAction");

                            if (DidUpdateNotificationStateForCharacteristicAction.ContainsKey(parts[1]))
                            {
                                //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicAction ContainsKey " + parts[1].ToString());

                                var characteristicAction = DidUpdateNotificationStateForCharacteristicAction[parts[1]];
                                if (characteristicAction != null)
                                {
                                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // have characteristicAction");

                                    if (characteristicAction.ContainsKey(parts[2]))
                                    {
                                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction ContainsKey " + parts[2].ToString());

                                        var action = characteristicAction[parts[2]];
                                        if (action != null)
                                        {
                                            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // have action");
                                            action(parts[2]);
                                        }
                                        //else
                                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // action null ");
                                    }
                                    //else
                                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction ! ContainsKey " + parts[2].ToString());
                                }
                                //else
                                //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction null");
                            }
                            //else
                            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicAction ! ContainsKey " + parts[1].ToString());
                        }
                        //else 
                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 1 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicAction null");


                        if (DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction != null)
                        {
                            if (DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction.ContainsKey(parts[1]))
                            {
                                //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction ContainsKey " + parts[1].ToString());

                                var characteristicAction = DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction[parts[1]];
                                if (characteristicAction != null)
                                {
                                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // have characteristicAction");

                                    if (characteristicAction.ContainsKey(parts[2]))
                                    {
                                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction ContainsKey " + parts[2]);

                                        var action = characteristicAction[parts[2]];
                                        if (action != null)
                                        {
                                            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // have action");

                                            action(parts[1], parts[2]);
                                        }
                                        //else
                                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // action null");
                                    }
                                    //else
                                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction ! ContainsKey " + parts[2]);
                                }
                                //else
                                //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // characteristicAction null");
                            }
                            //else
                            //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction ! ContainsKey " + parts[1].ToString());
                        }
                        //else
                        //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// 2 deviceDidUpdateNotificationStateForCharacteristic // DidUpdateNotificationStateForCharacteristicWithDeviceAddressAction null");
                    }
                    //else
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDidUpdateNotificationStateForCharacteristic // ! parts.Length >= 3");
                }
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceDidUpdateValueForCharacteristic // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceRequestMtu // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// deviceReadRSSI // ");
                ...
                {
                    //Debug.Log("BluetoothDeviceScript//OnBluetoothMessage// else // ");
